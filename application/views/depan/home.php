<section id="hero">
    ...
    <section id="beranda-tentang" style="font-family:Comfortaa">
        <div class="container">
            <div class="row">
                <div class="col-md-6 embed-responsive embed-responsive-16by9">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/76sW6xAQwww" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col-md-6 beranda-tentang-text my-5 my-md-auto">
                    <h2 class="display-5 text-center">Apa itu Filantropi ?</h2>
                    <p class="lead text-justify" style="font-size:1rem">
                        Filantropi Indonesia merupakan perhimpunan nirlaba dan independen, beranggotakan organisasi maupun jaringan lembaga-lembaga filantropi yang senantiasa berupaya untuk memajukan kedermawanan sosial dalam rangka mewujudkan keadilan dan pembangunan di seluruh Indonesia       </p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- ini mitra -->
    <section id="beranda-fitur" style="font-family:Comfortaa; background-image: none; background: #28a745 !important;">
    <h1 style="text-align:center" >Mitra Filantropi</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="w-75 mx-auto py-5">
                                    <h1 class="display-5 text-center">UNDP Indonesia</h1>
                                    <p class="lead text-center">Penjelasan tentang UNDP Indonesia</p>
                                    <a class="btn btn-primary btn-beranda w-100" href="produk.html"
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 order-last order-md-1">
                                <div class="w-75 mx-auto py-5">
                                    <h1 class="display-5 text-center">Ford Fondation</h1>
                                    <p class="lead text-center">Penjelasan tentang Ford Fondation</p>
                                    <a class="btn btn-primary btn-beranda w-100" href="produk.html"
                                        role="button">Lebih Lanjut</a>
                                </div>
                            </div>
                ...
                <div class="carousel-item">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 order-last order-md-1">
                                <div class="w-75 mx-auto py-5">
                                    <h1 class="display-5 text-center">WINGS</h1>
                                    <p class="lead text-center">Penjelasan tentang Wings</p>
                                    <a class="btn btn-primary btn-beranda w-100" href="produk.html"
                                        role="button">Lebih Lanjut</a>
                                </div>
                            </div>
                ...
                <div class="carousel-item">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="w-75 mx-auto py-5">
                                    <h1 class="display-5 text-center">SDG Philanthropy Platform</h1>
                                    <p class="lead text-center">Penjelasan tentang SDG</p>
                                    <a name="" id="" class="btn btn-primary btn-beranda w-100"
                                        href="produk.html" role="button">Lebih Lanjut</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="beranda-partner" style="font-family:Comfortaa">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 section-title">
                    <h1 class="display-5">Klaster Filantropi</h1>
                </div>
        ...
        <table>
            ...
            <tr>
            <td style="text-align: center;"><b>SDGs for better Indonesia</b></td>
            <td style="text-align: center;"><b>Zakat on SDGs</b></td>
            <td style="text-align: center;"><b>Pemukiman dan perkotaan</b></td>
            <td style="text-align: center;"><b>Pendidikan</b></td>
            <td style="text-align: center;"><b>Ketahanan pangan & Gizi</b></td>
            <td style="text-align: center;"><b>Lingkungan hidup & konserpasi</b></td>
        </tr>
            <tr>
    <th></th>
            ...
            <tr>
                <td></td>
                <td style="text-align: center;"><b>Kesenian & Kebudayaan</b></td>
                <td style="text-align: center;"><b>Kesehatan</b></td>
                <td style="text-align: center;"><b>pemberdayaan ekonomi & Kewirausahaan</b></td>
                <td style="text-align: center;"><b>Kewilayahan</b></td>
	...
	<section style="font-family:Comfortaa;">
    <h1 style="text-align:center" >Anggota Filantropi</h1>
        <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control-prev bg-dark" href="#carouselExampleControls2" role="button" data-slide="prev"
                style="width:5%">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next bg-dark" href="#carouselExampleControls2" role="button" data-slide="next"
                style="width:5%">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="sr-only">Next</span>
            </a>

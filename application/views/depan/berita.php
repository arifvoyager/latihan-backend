...
and is wrapped around the whole page content, except for the footer in this example -->
		<div class="w3-content" style="max-width:1400px; padding-top: 72px">
			...
			<div class="w3-row">
				...
				<div class="w3-col l8 s12">
					...
					<div class="w3-card-4 w3-margin w3-white">
						<img src="<?php echo base_url('') ?>./assets/img/woods.jpg" alt="Nature" style="width:100%">
					...
					<!-- Blog entry -->
					<div class="w3-card-4 w3-margin w3-white">
						<img src="<?php echo base_url('') ?>./assets/img/bridge.jpg" alt="Norway" style="width:100%">
						<div class="w3-container">
				...
				<div class="w3-col l4">
					...
					<div class="w3-card w3-margin w3-margin-top">
						<img src="<?php echo base_url('') ?>./assets/img/avatar_g.jpg" style="width:100%">
					...
					<div class="w3-card w3-margin">
						...
						<ul class="w3-ul w3-hoverable w3-white">
							...
							<li class="w3-padding-16">
								<img src="<?php echo base_url('') ?>./assets/img/skies.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
								<span class="w3-large">Dorum</span><br>
								<span>Ultricies congue</span>
							</li>
							<li class="w3-padding-16 w3-hide-medium w3-hide-small">
								<img src="<?php echo base_url('') ?>./assets/img/rock.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">

...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('jpanel/label'); ?>">Label</a></li>
    ...
    <div class="page-content">
        <div class="row">
            <form action="<?php echo base_url('jpanel/label/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation">
                                        ...
                                        <div class="col-md-6 left-padding">
                                            <div class="form-group">
                                                ...
                                                <div class=" col-lg-12 col-sm-12">
                                                    <input maxlength="50" type="text" class="form-control" name="label_flag_<?php echo $rsLang->language_code; ?>" id="label_flag_<?php echo $rsLang->language_code; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-sm-12">
                                                    <textarea class="form-control" name="label_caption_<?php echo $rsLang->language_code; ?>" id="label_caption_<?php echo $rsLang->language_code; ?>" rows="3"></textarea>
                                                </div>
                                            </div>

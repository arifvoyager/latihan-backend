...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('jpanel/posts/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                    ...
                    <div class="nav-tabs-horizontal nav-tabs-inverse">
                        ...
                        <div class="tab-content">
                            <?php
                                ...
                                //-GET SELECTED
                                $GET_SELECTED = $this->db->get_where('jawata_posts', array('posts_lock_code' => $LOCK_CODE, 'posts_lang' => $rsLang->language_code))->row();
        
                                if(count($GET_SELECTED) == 0) {
                                    $fields = $this->db->list_fields('jawata_posts');
                            ...
                            <div class="col-md-12 left-padding">
                                <select data-plugin="selectpicker" name="posts_category" id="posts_category">
                                    ...
                                    $GET_PAGE_CATEGORY = $this->db->get_where('jawata_taxonomy', array('taxonomy_flags' => 'pages_category', 'taxonomy_lang' => GET_DEFAULT_LANG()));
                                        foreach($GET_PAGE_CATEGORY->result() as $page_category):
                                            if ($page_category->taxonomy_slug == $SELECTED->row()->posts_category) {
                                                $CLASS = 'selected';
                                            } else {
                                                $CLASS = '';
                                            }
                                            echo "<option ".$CLASS." value=\"".$page_category->taxonomy_slug."\">".$page_category->taxonomy_caption."</option>";
                                        endforeach;
                                    ?>
                                </select>
                            </div>
                                  ...
                                  <div class="select2-primary">
                                    ...
                                    <?php
                                        ...
                                        foreach($GET_CAT->result() as $rsCategory):
                                            ...
                                            $TAGS = $SELECTED->row()->posts_tags;
                                            $TAGS_ARRAY = explode(";", $TAGS);
                                            foreach($TAGS_ARRAY as $tags):
                                            if($rsCategory->taxonomy_caption == $tags) {
                                                $selected = "selected";
                                                goto end;
                                            } else {
                                                $selected = "";
                                            ...
                                            echo "<option ".$selected." value=\"".$rsCategory->taxonomy_slug."\">".$rsCategory->taxonomy_caption."</option>";
                                        endforeach;
                                    ?>
                                    </select>
                                  </div>

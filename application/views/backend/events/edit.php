...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('cms/events'); ?>">Posts</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/events/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12" style="padding: 0px;">
                                <div class="input-group input-group-file">
                                    ...
                                    <div class='input-group date'  data-plugin="datepicker">
                                        <input type='text' class="form-control" name="posts_start_date" id="posts_start_date" value="<?php echo date('d-m-Y', strtotime($SELECTED->row()->posts_start_date)); ?>" />
                        ...
                        <div class="form-group">
                            <div class="col-md-12" style="padding: 0px;">
                                <div class="input-group input-group-file">
                                    ...
                                    <div class='input-group date'  data-plugin="datepicker">
                                        <input type='text' class="form-control" name="posts_end_date" id="posts_end_date" value="<?php echo date('d-m-Y', strtotime($SELECTED->row()->posts_end_date)); ?>" />
                                        <span class="input-group-addon" id="posts-date-calender">
                                            <span class="icon wb-calendar"></span>
                                        </span>
                                    </div>

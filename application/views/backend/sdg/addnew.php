...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/sdg/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                        ...
                        foreach($GET_LANG->result() as $rsLang):
                            ?>
                                posts_title_<?php echo $rsLang->language_code; ?>: {
                                    validators: {
                                        notEmpty: {
                                            message: 'SDGs title <?php echo $rsLang->language_code; ?> is required'
                                        }
                                    }
                                },
                                posts_images: {
                                    validators: {
                                        notEmpty: {
                                            message: 'SDGs Images <?php echo $rsLang->language_code; ?> is required'
                                        }
                                    }
                                },
                            <?php 

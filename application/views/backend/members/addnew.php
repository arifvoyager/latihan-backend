...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('cms/mitra'); ?>">Mitra</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/mitra/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <input type="text" class="form-control posts_title" name="posts_title_<?php echo $rsLang->language_code; ?>" id="posts_title_<?php echo $rsLang->language_code; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">Profile</label>
                                        <div class="col-lg-12 col-sm-12">
                                    ...
                                    <input type="hidden" class="form-control posts_slug" name="posts_slug_<?php echo $rsLang->language_code; ?>" id="posts_slug_<?php echo $rsLang->language_code; ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" id="pages_category">
                            <div class="col-md-12 left-padding right-padding">
                                <span>Mitra Category</span>
                            </div>
                            <div class="col-md-12 left-padding right-padding">
                                <select data-plugin="selectpicker" name="posts_category" id="posts_category">
                                    <option value="">-- Choose Type--</option>
                                    <?php 
                                        $get_mitra_category = $this->db->get_where('cd_taxonomy', array('taxonomy_flags' => 'mitra_cat', 'taxonomy_lang' => GET_DEFAULT_LANG()));
                                        
                                        foreach($get_mitra_category->result() as $mitra_cateogry):
                                            echo "<option value=\"".$mitra_cateogry->taxonomy_lock_code."\">".$mitra_cateogry->taxonomy_value."</option>";
                                        endforeach;
                                    ?>
                                </select>
                            </div>

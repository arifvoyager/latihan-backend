                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <input value="<?php echo $GET_SELECTED->posts_slug; ?>" type="hidden" class="form-control posts_slug" name="posts_slug_<?php echo $rsLang->language_code; ?>" id="posts_slug_<?php echo $rsLang->language_code; ?>">
                                ...
                                <select data-plugin="selectpicker" name="posts_category" id="posts_category">
                                    ...
                                    <?php 
                                        ...
                                        foreach($get_mitra_category->result() as $mitra_cateogry):
                                            if ($mitra_cateogry->taxonomy_lock_code == $SELECTED->row()->posts_category) {
                                                $CLASS = 'selected';
                                            } else {
                                                $CLASS = '';
                                            }
                                            echo "<option value=\"".$mitra_cateogry->taxonomy_lock_code."\" ".$CLASS.">".$mitra_cateogry->taxonomy_value."</option>";
                                        endforeach;
                                    ?>
                                </select>
                            </div>

...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('cms/members_due'); ?>">Members Due</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/members_due/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            <?php
                                ...
                                foreach($GET_LANG->result() as $rsLang):
                                    ...
                                    //-GET SELECTED
                                    $GET_SELECTED = $this->db->get_where('cd_taxonomy', array('taxonomy_lock_code' => $LOCK_CODE, 'taxonomy_lang' => $rsLang->language_code))->row();
                                        ...
                                        <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                            <div class="col-md-12" style="padding-top: 20px;">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-12 col-sm-12 control-label text-left">Due Name <?php if(GET_COMPANY('multilanguage') == 'Y') { echo $rsLang->language_flag; } ?></label>
                                                    <div class=" col-lg-12 col-sm-12">
                                                        <input value="<?php echo $GET_SELECTED->taxonomy_name; ?>" type="text" class="form-control" name="taxonomy_name_<?php echo $rsLang->language_code; ?>" id="taxonomy_name_<?php echo $rsLang->language_code; ?>">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-lg-12 col-sm-12 control-label text-left">Due Fee</label>
                                                    <div class="col-lg-12 col-sm-12">
                                                        <input value="<?php echo $GET_SELECTED->taxonomy_value; ?>" type="text" class="form-control" name="taxonomy_value_<?php echo $rsLang->language_code; ?>" id="taxonomy_value_<?php echo $rsLang->language_code; ?>" placeholder="1000000" />
                                                    </div>
                                                </div>

                                                <input value="<?php echo $GET_SELECTED->taxonomy_slug; ?>" type="hidden" class="form-control" name="taxonomy_slug_<?php echo $rsLang->language_code; ?>" id="taxonomy_slug_<?php echo $rsLang->language_code; ?>">
                                            </div>
                                        </div>
                                    <?php
                                    $iLoop++;
            ...
            .formValidation({
                ...
                fields: {
                    ...
                    <?php
                        ...
                        foreach($GET_LANG->result() as $rsLang):
                            ?>
                                taxonomy_name_<?php echo $rsLang->language_code; ?>: {
                                    validators: {
                                        notEmpty: {
                                            message: 'Due Name <?php echo $rsLang->language_code; ?> is required'
                                        }
                                    }
                                },
                                taxonomy_value_<?php echo $rsLang->language_code; ?>: {
                                    validators: {
                                        notEmpty: {
                                            message: 'Due Fee <?php echo $rsLang->language_code; ?> is required'
                                        }
                                    }
                                },
                            <?php 

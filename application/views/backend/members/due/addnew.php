...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/members_due/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <input type="text" class="form-control" name="taxonomy_name_<?php echo $rsLang->language_code; ?>" id="taxonomy_name_<?php echo $rsLang->language_code; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <input type="text" class="form-control" name="taxonomy_value_<?php echo $rsLang->language_code; ?>" id="taxonomy_value_<?php echo $rsLang->language_code; ?>" placeholder="1000000" />
                                        </div>
                                    </div>

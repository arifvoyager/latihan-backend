...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/about/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">About Title <?php if(GET_COMPANY('multilanguage') == 'Y') { echo $rsLang->language_flag; } ?></label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">About Short Description</label>
                                        <div class="col-lg-12 col-sm-12">
                ...
                <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <small>Minimal Image size : 600px x 450px</small>
                        </div>
                    </div>
                </div>

...
<div class="page animsition">
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <button type="button" class="btn btn-sm btn-icon btn-inverse btn-round" data-toggle="tooltip" data-original-title="Add New" onclick="javascript:location.href='<?php echo base_url('cms/about/addnew'); ?>'">
                        ...
                        <div class="example-wrap">
                            <div class="example">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" data-toggle="tooltip" data-original-title="Add New" onclick="javascript:location.href='<?php echo base_url('cms/about/addnew'); ?>'">
                                ...
                                <table id="loadDataTables" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="posts_title" class="col-md-2">Title About</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function($) {
        ...
        (function() {
            $('#loadDataTables').bootstrapTable({
                url: "<?php echo base_url("cms/about/getData"); ?>",
                search: true,
                pagination: true,
                showRefresh: true,
                showToggle: false,
    ...
    window.operateEvents = {
        'click .btn-edit': function (e, value, row, index) {
            window.location = BASE_URL + 'cms/about/editdata/' + row['posts_lock_code'];
        },
                        ...
                        callback: function () {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    window.location = BASE_URL + 'cms/about'
                                }
                            });
                ...
                buttons: {
                    ...
                    success: {
                        ...
                        callback: function () {
                            ...
                            $.ajax({
                                url : BASE_URL + 'cms/about/trashSelected/',
                                type: 'POST',

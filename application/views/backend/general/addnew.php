...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/general/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-12" style="padding-top: 20px;">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 col-sm-12">
                                                                <input value="" type="text" class="form-control" name="general_name_<?php echo $rsLang->language_code; ?>" id="general_name_<?php echo $rsLang->language_code; ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 col-sm-12">
                                                                <textarea class="form-control" name="general_caption_<?php echo $rsLang->language_code; ?>" id="general_caption_<?php echo $rsLang->language_code; ?>" rows="6"></textarea>
                                                            </div>
                                                        </div>

                                                        <input value="" type="hidden" class="form-control" name="general_tags_<?php echo $rsLang->language_code; ?>" id="general_tags_<?php echo $rsLang->language_code; ?>">
                                                        <input value="<?php echo $rsLang->language_code; ?>" type="hidden" class="form-control" name="general_lang_<?php echo $rsLang->language_code; ?>" id="general_lang_<?php echo $rsLang->language_code; ?>">
                                                        <input value="Y" type="hidden" class="form-control" name="general_multilanguage" id="general_multilanguage">
                                                    </div>
                                        ...
                                        <div class="tab-pane active" id="tab" role="tabpanel" style="background-color: #FFF;">
                                            <div class="col-md-12" style="padding-top: 20px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12 col-sm-12">
                                                        <input value="" type="text" class="form-control" name="general_name" id="general_name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-12 col-sm-12 control-label text-left">General Caption</label>
                                                    <div class="col-lg-12 col-sm-12">
                                                        <textarea class="form-control" name="general_caption" id="general_caption" rows="6"></textarea>
                                                    </div>
                                                </div>

                                                <input value="" type="hidden" class="form-control" name="general_tags" id="general_tags">
                                                <input value="N" type="hidden" class="form-control" name="general_multilanguage" id="general_multilanguage">
                                            </div>
                                        </div>
                                    <?php
                                }
...
<script type="text/javascript">
    <?php
        if ($this->uri->segment(4) != false && $this->uri->segment(4) == 'true') {
            $GET_LANG = GET_LANG();
            foreach($GET_LANG->result() as $rsLang):
                ?>
                    $( "#general_name_<?php echo $rsLang->language_code; ?>" ).keyup(function() {
                        TEXT_DESC = $("#general_name_<?php echo $rsLang->language_code; ?>").val();
                        TEXT_DESC = TEXT_DESC.replace (/[^a-z0-9]+|\s+/gmi, "_"); 
                        TEXT_DESC = TEXT_DESC.toLowerCase();

                        $("#general_tags_<?php echo $rsLang->language_code; ?>").val(TEXT_DESC);
                    });
                <?php 
            endforeach; 
        } else {
            ?>
                $( "#general_name" ).keyup(function() {
                    TEXT_DESC = $("#general_name").val();
                    TEXT_DESC = TEXT_DESC.replace (/[^a-z0-9]+|\s+/gmi, "_"); 
                    TEXT_DESC = TEXT_DESC.toLowerCase();

                    $("#general_tags").val(TEXT_DESC);
                });
            <?php
        }
    ?>

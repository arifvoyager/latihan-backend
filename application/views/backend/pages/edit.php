...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('cms/pages'); ?>">Pages</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/pages/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">TITLE PAGES <?php if(GET_COMPANY('multilanguage') == 'Y') { echo $rsLang->language_flag; } ?></label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">SUB TITLE PAGES</label>
                                        <div class=" col-lg-12 col-sm-12">
                                            <input value="<?php echo $GET_SELECTED->posts_subtitle; ?>" type="text" class="form-control" name="posts_subtitle_<?php echo $rsLang->language_code; ?>" id="posts_subtitle_<?php echo $rsLang->language_code; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <textarea class="form-control" name="posts_shortdesc_<?php echo $rsLang->language_code; ?>" id="posts_shortdesc_<?php echo $rsLang->language_code; ?>" rows="3"><?php echo $GET_SELECTED->posts_shortdesc; ?></textarea>
                                        </div>
                                    </div>
            ...
            <div class="col-md-3">
                ...
                <div class="panel panel-bordered panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">PAGE STYLES</h4>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 right-padding left-padding">
                                <input type="text" class="form-control" name="posts_sort" id="posts_sort" value="<?php echo $GET_SELECTED->posts_sort; ?>" />
                            </div>
                        </div>
                        <div class="form-group" id="pages_category">
                            <div class="col-md-12 left-padding right-padding">
                                <span>Pages Templates</span>
                            </div>
                            <div class="col-md-12 left-padding right-padding">
                                <select data-plugin="selectpicker" name="posts_file" id="posts_file">
                                    <option value="">-- Choose Type--</option>
                                    <option value="about.php" <?php if ($GET_SELECTED->posts_file == 'about.php') { echo 'selected="selected"'; }; ?>>About Us Page</option>
                                    <option value="news_list.php" <?php if ($GET_SELECTED->posts_file == 'news_list.php') { echo 'selected="selected"'; }; ?>>News Page</option>
                                    <option value="events_list.php" <?php if ($GET_SELECTED->posts_file == 'events_list.php') { echo 'selected="selected"'; }; ?>>Events Page</option>
                                    <option value="contact.php" <?php if ($GET_SELECTED->posts_file == 'contact.php') { echo 'selected="selected"'; }; ?>>Contact Page</option>
                                    <option value="gallery_list.php" <?php if ($GET_SELECTED->posts_file == 'gallery_list.php') { echo 'selected="selected"'; }; ?>>Gallery Page</option>
                                    <option value="download.php" <?php if ($GET_SELECTED->posts_file == 'download.php') { echo 'selected="selected"'; }; ?>>Article Page</option>
                                    <option value="organisasi_list.php" <?php if ($GET_SELECTED->posts_file == 'organisasi_list.php') { echo 'selected="selected"'; }; ?>>Organizations Page</option>
                                    <option value="mitra_list.php" <?php if ($GET_SELECTED->posts_file == 'mitra_list.php') { echo 'selected="selected"'; }; ?>>Partners Page</option>
                                    <option value="statis.php" <?php if ($GET_SELECTED->posts_file == 'statis.php') { echo 'selected="selected"'; }; ?>>Statis Page</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <small>Image size : <?php echo GET_GENERAL('page_banner_width'); ?>px x <?php echo GET_GENERAL('page_banner_height'); ?>px</small>
                        </div>
                    </div>
                </div>
                <!-- End Example Panel With Heading -->

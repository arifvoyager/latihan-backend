...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('jpanel/pages'); ?>">Pages</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('jpanel/pages/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <input type="text" class="form-control" name="posts_title_<?php echo $rsLang->language_code; ?>" id="posts_title_<?php echo $rsLang->language_code; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <input type="text" class="form-control" name="posts_subtitle_<?php echo $rsLang->language_code; ?>" id="posts_subtitle_<?php echo $rsLang->language_code; ?>" data-required="true">
                                        </div>
                                    </div>
                        ...
                        <div class="form-group" id="pages_category">
                            ...
                            <div class="col-md-12 left-padding right-padding">
                                <select data-plugin="selectpicker" name="posts_file" id="posts_file">
                                    <!--
                                    <option value="">-- Choose Type--</option>
                                    <option value="about.php">About Us Page</option>
                                    <option value="news_list.php">News Page</option>
                                    <option value="events_list.php">Events Page</option>
                                    <option value="contact.php">Contact Page</option>
                                    <option value="gallery_list.php">Gallery Page</option>
                                    <option value="download.php">Article Page</option>
                                    <option value="organisasi_list.php">Organizations Page</option>
                                    <option value="mitra_list.php">Partners Page</option>
                                    -->
                                    <option value="statis.php">Statis Page</option>
                                </select>
                            </div>
                        </div>
                    </div>

...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
            <form action="<?php echo base_url('jpanel/category/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation">
                            ...
                            <div class="tab-content">
                                <?php
                                    ...
                                    foreach($GET_LANG->result() as $rsLang):
                                        ...
                                        //-GET SELECTED
                                        $GET_SELECTED = $this->db->get_where('jawata_taxonomy', array('taxonomy_lock_code' => $LOCK_CODE, 'taxonomy_lang' => $rsLang->language_code))->row();
                                        if(count($GET_SELECTED) == 0) {
                                            $fields = $this->db->list_fields('jawata_taxonomy');
                                                ...
                                                <div class="col-md-6 left-padding">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class=" col-lg-12 col-sm-12">
                                                            <input maxlength="50" value="<?php echo $GET_SELECTED->taxonomy_caption; ?>" type="text" class="form-control" name="taxonomy_caption_<?php echo $rsLang->language_code; ?>" id="taxonomy_caption_<?php echo $rsLang->language_code; ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            <textarea class="form-control" name="taxonomy_desc_<?php echo $rsLang->language_code; ?>" id="taxonomy_desc_<?php echo $rsLang->language_code; ?>" rows="3"><?php echo $GET_SELECTED->taxonomy_desc; ?></textarea>
                                                        </div>
                                                    </div>

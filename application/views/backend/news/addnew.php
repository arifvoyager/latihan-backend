...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('cms/news'); ?>">News</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/news/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">News Category <?php if(GET_COMPANY('multilanguage') == 'Y') { echo $rsLang->language_flag; } ?></label>
                                            ...
                                            <select data-plugin="selectpicker" name="posts_category_<?php echo $rsLang->language_code; ?>" id="posts_category_<?php echo $rsLang->language_code; ?>">
                                                ...
                                                <?php 
                                                    ...
                                                    foreach ($get_news_cate->result() as $news_cate):
                                                        echo '<option value="'.$news_cate->taxonomy_lock_code.'">'.$news_cate->taxonomy_value.'</option>';
                                                    endforeach;
                                                ?>
                                            </select>
                                        </div>
                ...
                <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12" style="padding: 0px;">
                                <input class="form-control" type="text" name="posts_source" id="posts_source" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        foreach($GET_LANG->result() as $rsLang):
                            ?>
                                posts_title_<?php echo $rsLang->language_code; ?>: {
                                    validators: {
                                        notEmpty: {
                                            message: 'News title <?php echo $rsLang->language_code; ?> is required'
                                        }
                                    }
                                },
                            <?php 

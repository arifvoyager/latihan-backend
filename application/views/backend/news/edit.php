...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('cms/news'); ?>">Posts</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/news/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <select data-plugin="selectpicker" name="posts_category_<?php echo $rsLang->language_code; ?>" id="posts_category_<?php echo $rsLang->language_code; ?>">
                                                ...
                                                <?php 
                                                    $get_news_cate   = $this->db->get_where('cd_taxonomy', array('taxonomy_flags' => 'news_cat', 'taxonomy_lang' => $rsLang->language_code));

                                                    foreach ($get_news_cate->result() as $news_cate):
                                                        $selected       = '';
                                                        if ($news_cate->taxonomy_lock_code == $GET_SELECTED->posts_category) {
                                                            $selected      = 'selected="selected"';
                                                        }
                                                        echo '<option value="'.$news_cate->taxonomy_lock_code.'" '.$selected.'>'.$news_cate->taxonomy_value.'</option>';
                                                    endforeach;
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">News Title <?php if(GET_COMPANY('multilanguage') == 'Y') { echo $rsLang->language_flag; } ?></label>
                                        <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">News Short Description</label>
                                        <div class="col-lg-12 col-sm-12">
                ...
                <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <small>News Image Size : 700px x 340px</small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12" style="padding: 0px;">
                                <input class="form-control" type="text" name="posts_source" id="posts_source" value="<?php echo $SELECTED->row()->posts_source; ?>" />
                            </div>
                        </div>
                    </div>
                </div>

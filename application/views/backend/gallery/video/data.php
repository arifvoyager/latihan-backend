...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('jpanel/gallery'); ?>">Gallery</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
                        ...
                        <div class="example-wrap">
                            <div class="example">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" data-toggle="tooltip" data-original-title="Add New" onclick="javascript:location.href='<?php echo base_url('jpanel/gallery/addnew/video'); ?>'">
                                ...
                                <table id="loadDataTables" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="posts_title">GALLERY NAME</th>
                                            <th data-field="gallery_category_name">GALLERY CATEGORY</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function($) {
        ...
        (function() {
            $('#loadDataTables').bootstrapTable({
                url: "<?php echo base_url("jpanel/gallery/getData/video"); ?>",
                search: true,
                pagination: true,
                showRefresh: true,
                showToggle: false,
    ...
    window.operateEvents = {
        'click .btn-edit': function (e, value, row, index) {
            window.location = BASE_URL + 'jpanel/gallery/editdata/video/' + row['posts_lock_code'];
        },
        
        'click .btn-image': function (e, value, row, index) {
            window.location = BASE_URL + 'jpanel/gallery/link/' + row['posts_lock_code'];
        },
                ...
                buttons: {
                    ...
                    success: {
                        ...
                        callback: function () {
                            ...
                            $.ajax({
                                url : BASE_URL + 'jpanel/gallery/trash/video_link',
                                type: 'POST',
                                data: {
                                ...
                                success: function (response) {
                                    ...
                                    window.location = BASE_URL + 'jpanel/gallery/data/video'
                                }
                            });
                ...
                buttons: {
                    ...
                    success: {
                        ...
                        callback: function () {
                            ...
                            $.ajax({
                                url : BASE_URL + 'jpanel/gallery/trashSelected/video_link',
                                type: 'POST',

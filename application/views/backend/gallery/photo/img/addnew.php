...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
            <form action="<?php echo base_url('jpanel/gallery/saved/galley_img'); ?>" enctype="multipart/form-data" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation">
                <div class="col-md-6 panel">
                    ...
                    <div class="col-md-12 left-padding">
                        ...
                        <div class="form-group">
                            <label class="col-lg-12 col-sm-12 control-label text-left">IMAGE TITLE</label>
                            <div class=" col-lg-12 col-sm-12">
                                <input type="text" class="form-control" name="posts_title" id="posts_title">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label class="col-lg-12 col-sm-12 control-label text-left">IMAGE</label>
                            <div class="col-lg-12 col-sm-12">
                        ...
                        <input type="hidden" class="form-control" name="brand_slug" id="brand_slug">
                        <div class="form-group">

...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('jpanel/gallery/data/photo'); ?>">Gallery</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('jpanel/gallery/updated/photo/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <select data-plugin="selectpicker" name="posts_tags_<?php echo $rsLang->language_code; ?>" id="posts_tags_<?php echo $rsLang->language_code; ?>">
                                                ...
                                                <?php   
                                                    $get_gallery_category = $this->db->get_where('dp_taxonomy', array('taxonomy_flags' => 'GALLERY_CATEGORY', 'taxonomy_value' => 'image', 'taxonomy_lang' => $rsLang->language_code));
                                    ...
                                    <input value="<?php echo $GET_SELECTED->posts_lang; ?>" type="hidden" name="posts_lang_<?php echo $rsLang->language_code; ?>" id="posts_lang_<?php echo $rsLang->language_code; ?>" value="<?php echo $rsLang->language_code; ?>" />
                                    <input value="<?php echo $GET_SELECTED->posts_slug; ?>" type="hidden" name="posts_slug_<?php echo $rsLang->language_code; ?>" id="posts_slug_<?php echo $rsLang->language_code; ?>" />
                                </div>

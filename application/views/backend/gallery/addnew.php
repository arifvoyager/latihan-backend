...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('jpanel/gallery/saved'); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <input type="hidden" name="taxonomy_slug_<?php echo $rsLang->language_code; ?>" id="taxonomy_slug_<?php echo $rsLang->language_code; ?>" />
                                </div>

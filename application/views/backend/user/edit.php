...
<div class="page animsition">
    ...
    <div class="page-content">
        <div class="row">
            <form action="<?php echo base_url('jpanel/user/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12" style="margin-top: 20px;">
                        <div class="form-group">
                            ...
                            <div class=" col-lg-12 col-sm-12">
                                <input value="<?php echo $SELECTED->row()->userlogin_aliasname; ?>" maxlength="50" type="text" class="form-control" name="userlogin_aliasname" id="userlogin_aliasname">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-12 col-sm-12">
                                <input value="<?php echo $SELECTED->row()->userlogin_email; ?>" type="text" class="form-control" name="userlogin_email" id="userlogin_email" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-12 col-sm-12">
                                <input value="<?php echo $SELECTED->row()->userlogin_username; ?>" maxlength="50" type="text" class="form-control" name="userlogin_username" id="userlogin_username" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo $SELECTED->row()->userlogin_avatar; ?>" type="hidden" class="form-control" name="userlogin_avatar_temp" id="userlogin_avatar_temp">
                            <div class=" col-lg-12 col-sm-12">
                                <img src="<?php echo base_url("pubs/uploads/".$SELECTED->row()->userlogin_avatar); ?>" class="img-responsive" style="margin-bottom: 10px;">
                            ...
                            <div class=" col-lg-12 col-sm-12">
                                <ul class="list-unstyled list-inline">
                                    <li class="margin-right-25 margin-bottom-25">
                                        <input type="checkbox" name="userlogin_status" class="js-switch-small" value="Y" data-plugin="switchery" data-size="small" <?php if($SELECTED->row()->userlogin_status == 'Y') { echo "checked"; } ?> />
                                    </li>
                                </ul>
                            </div>
                        </div>

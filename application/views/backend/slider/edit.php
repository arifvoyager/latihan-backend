...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('jpanel/slider'); ?>">Slider</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('jpanel/slider/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <textarea class="form-control" name="posts_shortdesc_<?php echo $rsLang->language_code; ?>" id="posts_shortdesc_<?php echo $rsLang->language_code; ?>" rows="5"><?php echo $GET_SELECTED->posts_shortdesc; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel-body" style="padding-top: 20px;">
                        <div class="form-group">
                            ...
                            <div class=" col-md-12 col-sm-12" style="padding: 0px;">
                                <input value="<?php echo $SELECTED->row()->posts_sort; ?>" type="text" class="form-control" name="posts_sort" id="posts_sort">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12" style="padding: 0px;">
                                <input placeholder="http://" class="form-control" type="text" name="posts_link" id="posts_link" value="<?php echo $SELECTED->row()->posts_link; ?>" />
                            </div>
                        </div>
                    </div>
                </div>

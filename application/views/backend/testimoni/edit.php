...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('jpanel/testimoni'); ?>">Testimoni</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('jpanel/testimoni/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane <?php echo $strActive; ?>" id="tab_<?php echo $rsLang->language_code; ?>" role="tabpanel" style="background-color: #FFF;">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">Testimoni From <?php if(GET_SETTING('multilanguage') == 'Y') { echo $rsLang->language_flag; } ?></label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-sm-12 control-label text-left">Testimoni</label>
                                        <div class="col-lg-12 col-sm-12">
...
<script type="text/javascript">
    ...
    //- TEXTEDITOR
    CKEDITOR.replace('posts_content_<?php echo $rsLang->language_code; ?>', {
        height: 400,
        ...
        $('#frmvalidation')
            .formValidation({
                ...
                fields: {
                    ...
                    <?php
                         $GET_LANG = $this->db->query("SELECT * FROM jawata_language WHERE language_status = 'Y' ORDER BY language_default DESC");
                         foreach($GET_LANG->result() as $rsLang):
                    ?>

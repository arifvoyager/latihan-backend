...
<div class="page animsition">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url('cms/download_cat'); ?>">Article Category</a>
            </li>
            <li class="active">
                <?php echo $TITLE_PAGE; ?>
            </li>
    ...
    <div class="page-content">
        <div class="row">
        <form action="<?php echo base_url('cms/download_cat/updated/'.$LOCK_CODE); ?>" class="form-horizontal" method="post" name="frmaddnew" id="frmvalidation" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12" style="padding-top: 20px;">
                                    <div class="form-group">
                                        ...
                                        <div class=" col-lg-12 col-sm-12">
                                            <input type="text" class="form-control" name="taxonomy_value_<?php echo $rsLang->language_code; ?>" id="taxonomy_value_<?php echo $rsLang->language_code; ?>" value="<?php echo $GET_SELECTED->taxonomy_value; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <textarea class="form-control" name="taxonomy_name_<?php echo $rsLang->language_code; ?>" id="taxonomy_name_<?php echo $rsLang->language_code; ?>" rows="3"><?php echo $GET_SELECTED->taxonomy_name; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
class Mitra extends CI_Controller {
	...
	public function index() {
        if ($this->session->userdata('sess_cpanelx') == TRUE) {
            ...
            $data['STR_PAGES']       = 'PAGE_MITRA';
            $data['STR_MENU']        = 'mitra';
            $data['TITLE_PAGE']      = 'Mitra';
            $data['content']         = 'mitra/data.php';
    ...
    public function getData() {
        if ($this->session->userdata('sess_cpanelx') == TRUE) {
            ...
            $GET_LANG = $this->db->query("SELECT * FROM cd_posts WHERE posts_type = 'mitra' AND posts_lang = '".GET_DEFAULT_LANG()."' GROUP BY posts_lock_code ORDER BY posts_date DESC");
            $strArray = array();
	...
	public function addnew() {
        if ($this->session->userdata('sess_cpanelx') == TRUE) {
            ...
            $data['STR_PAGES']       = 'PAGE_MITRA_ADDNEW';
            $data['STR_MENU']        = 'mitra';
            $data['TITLE_PAGE']      = 'Add New';
            $data['content']         = 'mitra/addnew.php';
            $this->load->view('backend/index', $data);

...
class About extends CI_Controller {
	...
	public function index() {
        if ($this->session->userdata('sess_cpanelx') == TRUE) {
            ...
            $data['STR_PAGES']       = 'PAGE_ABOUT';
            $data['STR_MENU']        = 'about';
            $data['TITLE_PAGE']      = 'About';
            $data['content']         = 'about/data.php';
    ...
    public function getData() {
        if ($this->session->userdata('sess_cpanelx') == TRUE) {
            ...
            $GET_LANG = $this->db->query("SELECT * FROM cd_posts A WHERE posts_type = 'about' AND posts_lang = '".GET_DEFAULT_LANG()."' GROUP BY posts_lock_code ORDER BY posts_date DESC");
            $strArray = array();

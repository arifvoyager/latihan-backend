...
$.components.register("strength", {
  ...
  defaults: {
    ...
    templates: {
      toggle: '<div class="checkbox checkbox-primary show-password-wrap"><input type="checkbox" class="{toggleClass}" title="Show/Hide Password" id="show_password" /><label for="show_password">Show Password</label></div>',
